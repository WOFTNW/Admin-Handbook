...
- **`(option1 | option2)`** - A required "or", meaning you _must_ use one field or another.
- **`[option1 | option2]`** - An optional "or", meaning you _may_ use one field or another if you wish.

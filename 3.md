...
Dreamvisitor, created by Bog specifically for the server, has a variety of features. It serves as an all-in-one utility plugin and Discord bot. Here are some important commands:
...
| `/setrole <type> <role>` | 🛡️ 📗 Set a role. |
| `/list` | 📗 List online players. |
| `/tempban <username> <hours> <reason>` | 🛡️ 📕 Tempban an online player from the Minecraft server. |
| `/msg <username> <message>` | 📗 Message a player on the Minecraft server. |
...
| `/panic` | 🛡️ 📕 Kick all players from the server and set the player limit to 0. This will <i>not</i> ask for confirmation. |
...
| [#i-need-help-❗](https://discord.com/channels/658004601869565962/849091822525218848) | Players in the joining process can reach out for assistance. Typically, admins don't need to be involved and Helpers should be able to take care of this. |
...
| [#about-staff](https://discord.com/channels/658004601869565962/932158281114353675) | Contains information about staff roles and staff introductions. Update yours if you're a new admin or trial admin! |
...
| [#questions](https://discord.com/channels/658004601869565962/854952453133041664) | Like #i-need-help-❗, Helpers should mostly be able to take care of this channel, but occasionally there may be more technical questions. |
...
| [#bug-report](https://discord.com/channels/658004601869565962/791102701307691043) | Bugs are posted by the players here. Report them to the appropriate staff member if it is specific to one. |
...
| [#log](https://discord.com/channels/658004601869565962/660597606233276436) | System channel, logs actions. Not visible to trial admins. |
